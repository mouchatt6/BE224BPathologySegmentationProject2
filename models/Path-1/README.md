...
|---|---|---|---|
| [v1-baseline](v1-baseline/) | Frozen 3-CNN features + MLP, 4-way flip TTA | 0.9393 | 0.9055 |
| [v2-stainnorm-ensemble](v2-stainnorm-ensemble/) | + Macenko stain norm, rot6 TTA, label smoothing 0.05, late fusion | **0.9470** | **0.9143** |

**The v1→v2 story:** v1's sizable OOF→LB gap is train/test stain
